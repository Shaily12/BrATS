# -*- coding: utf-8 -*-
"""Copy of brats_segmentation_3d.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gWLpAoVoT0n1skaCGOr-4Rr1NxUC0NJv
...
!python -c "import monai" || pip install -q "monai-weekly[nibabel, tqdm, ignite, torchvision]"
...
from monai.data import DataLoader, decollate_batch, NibabelReader
...
class ConvertToMultiChannelBasedOnBratsClassesd(MapTransform):
    ...
    def __call__(self, data):
        ...
        for key in self.keys:
            ...
            #print("ConvertToMultiChannelBasedOnBratsClassesd", d[key].shape)
        return d
...
class ConvertToMultiChannelBasedOnBratsClasses(Transform):
    ...
    def __call__(self, data):
        ...
        print("Data before stacking", result.shape)
        data = np.stack(result, axis=0).astype(np.float32)
        print("SHAPE OF RESULT DATA", data.shape)
        return data
...
model.load_state_dict(
    torch.load("/content/best_metric_model.pth")
)
model.eval()
with torch.no_grad():
    ...
    #print(f"VAL input type and shape: {val_input.shape} {type(val_input)}")
    roi_size = (128, 128, 64)
    sw_batch_size = 4
...
data = test_transform('/content/BRATS_485.nii.gz')
data[0].shape

plt.imshow(data[0][3,:,:,50],cmap='gray')
plt.axis('on')
plt.show()
